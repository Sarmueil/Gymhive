...
const Header = () => {
    ...
    return (
        <div className='w-full sticky top-0 z-[1000] bg-white'>
            ...
            <div className='hidden md:flex justify-between items-center py-[2px] px-[30px] sticky top-0 bg-white z-[100] cursor-pointer'>
                ...
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center'>
                        <ShoppingCartIcon className='w-[40px] h-[40px] cursor-pointer' onClick={() => setShowCart(true)} />
                        <div className='bg-[#FCA311] text-black text-[14px] rounded-full py-1 px-2 text-center'>{totalQuantities || 0}</div>
                    </div>
                    <div className='mr-[13px] p-[6px] bg-black text-white rounded-lg cursor-pointer text-[16px] font-[Josefin Sans] ml-4' onClick={() => Navigate(`/new`)}>Explore</div>
                </div>
                {showCart && <Cart />}
            </div>
            ...
            <div className='md:hidden flex justify-between items-center py-2 px-4'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <div className='flex items-center'>
                        <ShoppingCartIcon className='w-[30px] h-[30px] cursor-pointer' onClick={() => setShowCart(true)} />
                        <div className='bg-[#FCA311] text-black text-[12px] rounded-full py-1 px-2 text-center'>{totalQuantities || 0}</div>
                    </div>
