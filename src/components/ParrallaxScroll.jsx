                ...
                <div className='absolute text-[#E5E5E5] top-0 left-0 w-full h-[60vh] md:h-[80vh] bg-[rgba(0,0,0,0.4)]'>
                    ...
                    <div className='flex mt-[20px] ml-[2%]'>
                        {['Explore', 'Shop'].map((menu, index) => (
                            <div className='bg-[#E5E5E5] text-black p-[7px] rounded-lg cursor-pointer font-[Josefin Sans] text-[18px] tracking-normal mr-[15px] hover:bg-black hover:text-white transition-all' key={index}>{menu}</div>
                        ))}
                    </div>
                </div>
            </div>
