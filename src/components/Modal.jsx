...
const Modal = () => {
    ...
    const { totalPrice, closeModal } = useStoreContext();
    return (
        <>
            <div className="fixed inset-0 z-[1000] flex items-center justify-center">
                <div className="absolute inset-0 bg-[rgba(0,0,0,0.7)]" onClick={()=>closeModal()}></div>
                <div className="relative z-10 bg-white px-6 py-6 md:py-8 rounded-lg shadow-lg w-[90%] md:w-[550px]">
                    <div className='flex items-center justify-between mb-4 py-3'>
                        ...
                        <h2 className='text-[25px] md:text-[30px] font-bold text-[#FCA311]'><span>&#8358;</span>{totalPrice}</h2>
                    </div>
